...
def GamePlay2(player_choice):
    ...
    # convert the player's choice to player_number using hte function name_to_number()
    player_number = name_to_number(player_choice)

    # compute the random guess for the computer_number using random.randrange()
    computer_number = random.randrange(0, 5)

    # convert the computer number to name using the function number_to_name()
    computer_choice = number_to_name(computer_number)

    # print out the message for the computer's choice
    print("Computer chooses: " + computer_choice)

    # compute the difference of computer_number and player_number modulo five
    difference = ((player_number - computer_number) % 5)

    print("Difference: " + difference)

    # determine the winner, and print out the winner message
    if (difference == 1 or difference == 2):
        print("Player wins!")
    elif (difference == 3 or difference == 4):
